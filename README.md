...
# References
* [This GitHub repository](https://github.com/bom4v/ti-spark-all)
...
## Short version
Just add the dependency on `ti-spark-all` in the SBT project
configuration (typically, `build.sbt` in the project root directory):
```scala
libraryDependencies += "org.bom4v.ti" %% "ti-spark-all" % "0.0.1-spark2.3"
```
